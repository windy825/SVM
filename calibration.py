...
def undistort(img, side, ratio):    
    ...
    if side == 'back' :
        ...
        DIM=(640, 480)
        K=np.array([[236.00033166136186, 0.0, 320.80698188362993], [0.0, 235.65832997607666, 248.32680556708823], [0.0, 0.0, 1.0]])
    ...
    DIM=(640, 480)
    K=np.array([
        [235.1982364007136, 0.0, 320.722613672998], 
        [0.0, 234.7955596475616, 250.22150003050075], 
        [0.0, 0.0, 1.0]])
    D=np.array([
        [-0.05024307206669386], 
        [0.003083654157514218], 
        [-0.0038559072176334217], 
        [0.0006626971518285512]])
...
side = 'front'
ratio = 1.5
images = glob.glob('./pp/front_square.png')
